(custom-set-variables
 ...
 '(package-selected-packages
   '(clojure-mode-extra-font-locking cider clojure-mode bison-mode exec-path-from-shell haskell-mode markdown-mode smart-hungry-delete rust-mode benchmark-init ox-reveal speed-type helpful magit meow move-text consult-dir magit-todos mood-line youdao-dictionary doom-modeline ahk-mode vertico-directory fish-mode fish python-black py-yapf yapfify tldr quickrun consult-eglot all-the-icons doct org-super-agenda valign org-appear shackle wakatime-mode restart-emacs pyim-basedict pyim prettify-math prettify-greek rainbow-delimiters gcmh selectric-mode selectic-mode info-colors magit-delta eros which-key avy systemd hl-todo module))
