...
#+end_src
*** meow
i prefer stay in insert mode, only use `normal mode' when need.
C-space will be the key to enter and leave normal mode
`meow-mode-state-list'
disable meow in magit
**** meow setup
#+begin_src emacs-lisp
(use-package meow)
(defun meow-setup ()
